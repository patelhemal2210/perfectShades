...
function displayColor($colors){
    foreach ($colors as $color) {
        ...
        echo "<tr>
                <td>".$id."</td>
                <td>".$description."</td>
                <td><a href='#editor_color' class='open-EditColorDialog btn btn-xs btn-primary' data-toggle='modal' data-target='#EditColorModal' role='button'
                data-color-id='".$id."'
                data-color-description='".$description."'
                >Edit</a>
                <a href='tables_processing.php?id=".$id."&action=DeleteColor' class='btn btn-xs btn-danger'>Delete</a></td>
            </tr>";
    }
};
?>
...
<body>
    ...
    <script>
        $(document).on("click", ".open-EditColorDialog", function () {
            ...
            var colorDescription = $(this).data('color-description');

            $(".modal-body #color_id").val( colorID );
            $(".modal-body #color_description").val( colorDescription );
